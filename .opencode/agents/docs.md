...
**Scope:** These style and information-design instructions apply to project documentation, not agent instruction files. Write agent instructions concisely, unambiguously, clearly, and imperatively.
