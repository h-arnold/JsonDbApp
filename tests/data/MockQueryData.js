...
const MockQueryData = {
    ...
    return [
      {
        ...
        orders: [
          { id: 'ord-001', amount: 125.5, date: new Date('2023-08-15') },
      ...
      },
      {
        ...
        orders: [{ id: 'ord-003', amount: 79.99, date: new Date('2023-07-10') }],
        settings: {
          theme: 'light',
          notifications: {
            email: true,
      ...
      },
      {
        ...
        orders: [
          ...
          { id: 'ord-005', amount: 27.5, date: new Date('2023-05-17') },
  ...
  getEdgeCaseDocuments() {
    return [
      ...
      {
        _id: 'edge3',
        sameValueDifferentTypes: [123, '123', true, new Date(123)],
   ...
   */
  getAllTestDocuments() {
    return [...this.getTestUsers(), ...this.getTestProducts(), ...this.getEdgeCaseDocuments()];
  },
