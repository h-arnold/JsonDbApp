...
**Always descriptive, use complete words, avoid abbreviations, use British English and follow these patterns**:
...
**Validation**: Use `Validate` class. Class specific validation implemented as private method.
