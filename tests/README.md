...
This directory is the home of the Vitest-based test harness.
...
Use `npm run test` from the repository root; it uses the configuration under this directory via `vitest run --config tests/vitest.config.js`.
